...
urlpatterns = [
    ...
    url(r'^deletecredits/$', profiles_views.credit_delete, name='deletecredit'),
    url(r'^employees/$', profiles_views.show_employee, name='employees'),
    url(r'^employees/delete$', profiles_views.employee_delete, name='deleteemployee'),
    url(r'^invoices/$', profiles_views.show_invoice, name='invoices'),
    url(r'^invoices/delete$', profiles_views.invoice_delete, name='deleteinvoice'),
